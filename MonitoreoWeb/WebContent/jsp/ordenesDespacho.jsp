...
<title>Órdenes de despacho</title>
</head>

<body style="background-color: gray;">
	<form action="../SVBuscarOrdenesDespacho" id="formulario1" method="post">
				...
				<div class="ui-grid-c" style="background-color: gray;">
					<div class="ui-block-a"
						...
						<div data-role="popup" id="popupHelp"
							...
							<p>Ingrese el número de venta para ver la orden de despacho asociada a la misma.</p>
						</div>
					</div>
					<div class="ui-block-b">
						<label for="imputVenta"  style="background-color: gray; color:orange;">Número de venta:</label>
