...
public class WSInformeAuditoriaBeanServiceLocator extends org.apache.axis.client.Service implements com.monitor.webService.WSInformeAuditoriaBeanService {
    ...
    private java.lang.String WSInformeAuditoriaBeanPort_address = "http://localhost:8080/PruebaEjb/WSInformeAuditoriaBean";
    ...
    public com.monitor.webService.WSInformeAuditoriaBean getWSInformeAuditoriaBeanPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.monitor.webService.WSInformeAuditoriaBean getWSInformeAuditoriaBeanPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.monitor.webService.WSInformeAuditoriaBeanServiceSoapBindingStub _stub = new com.monitor.webService.WSInformeAuditoriaBeanServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.monitor.webService.WSInformeAuditoriaBean.class.isAssignableFrom(serviceEndpointInterface)) {
                com.monitor.webService.WSInformeAuditoriaBeanServiceSoapBindingStub _stub = new com.monitor.webService.WSInformeAuditoriaBeanServiceSoapBindingStub(new java.net.URL(WSInformeAuditoriaBeanPort_address), this);
                _stub.setPortName(getWSInformeAuditoriaBeanPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webService.monitor.com/", "WSInformeAuditoriaBeanService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webService.monitor.com/", "WSInformeAuditoriaBeanPort"));
        }
