...
public class WSProcVentaBeanServiceLocator extends org.apache.axis.client.Service implements com.monitor.webService.WSProcVentaBeanService {
    ...
    private java.lang.String WSProcVentaBeanPort_address = "http://localhost:8080/PruebaEjb/WSProcVentaBean";
    ...
    public com.monitor.webService.WSProcVentaBean getWSProcVentaBeanPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.monitor.webService.WSProcVentaBeanServiceSoapBindingStub _stub = new com.monitor.webService.WSProcVentaBeanServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.monitor.webService.WSProcVentaBean.class.isAssignableFrom(serviceEndpointInterface)) {
                com.monitor.webService.WSProcVentaBeanServiceSoapBindingStub _stub = new com.monitor.webService.WSProcVentaBeanServiceSoapBindingStub(new java.net.URL(WSProcVentaBeanPort_address), this);
                _stub.setPortName(getWSProcVentaBeanPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webService.monitor.com/", "WSProcVentaBeanService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webService.monitor.com/", "WSProcVentaBeanPort"));
        }
